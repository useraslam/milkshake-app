...
export const TOGGLE_THEME_BEGIN = "TOGGLE_THEME-BEGIN";
export const TOGGLE_THEME_SUCCESS = "TOGGLE_THEME-SUCCESS";
export const TOGGLE_THEME_FAILURE = "TOGGLE_THEME-FAILURE";
